	...
	*/
	...
	Popup.checkDocking = function(){
		if (this.getOpenState() === sap.ui.core.OpenState.OPEN) {
			var oCurrentOfRef = this._oLastPosition.of instanceof sap.ui.core.Element ? this._oLastPosition.of.getDomRef() : this._oLastPosition.of,
			...
			// properly again
			if (!jQuery.sap.containsOrEquals(document, oCurrentOfRef)) {
