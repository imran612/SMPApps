...
sap.ui.jsview("com.jabil.maestro.mob.view.Login", {
              ...
              page.setCustomHeader(new sap.m.Bar({contentMiddle: new sap.ui.core.HTML({content:"<div class='headerLogoStyle'>Maestro <span>Orchestrator</span></div>"}) }));
              ...
              //page.addContent(new sap.m.Label({text:"Password"}));
