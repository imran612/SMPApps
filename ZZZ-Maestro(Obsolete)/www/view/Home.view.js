...
sap.ui.jsview("com.jabil.maestro.mob.view.Home", {
      ...
      createContent : function(oController) {
              ...
              page.setCustomHeader(new sap.m.Bar({contentMiddle: new sap.ui.core.HTML({content:"<div class='headerLogoStyle'>Maestro <span>Orchestrator</div>"}), contentRight:new sap.m.Image({src:"img/logout.png", press: oController.handleLogoff}) }));
