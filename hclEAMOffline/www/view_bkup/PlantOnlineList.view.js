...
sap.ui.jsview("ui5bp.view.PlantOnlineList", {

    getControllerName: function() {
        return "ui5bp.view.PlantOnlineList";
    },
    ...
    createContent: function(oController) {
        ...
        var oList = new sap.m.List(this.createId("plantOnlineList"),{
            selectionChange: [oController.onPlantSelect, oController],
            mode: sap.m.ListMode.SingleSelectMaster,
            items: {
                    path:"/WOLIST",
                    template:oListTemplate,
                    sorter: new sap.ui.model.Sorter("Orderid")
            }
        });
