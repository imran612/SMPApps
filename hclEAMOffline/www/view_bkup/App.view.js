...
sap.ui.jsview("ui5bp.view.App", {
    ...
    createContent: function(oController) {
        ...
        this.app.addDetailPage(sap.ui.jsview("PlantOnlineList", "ui5bp.view.PlantOnlineList"));
        this.app.addDetailPage(sap.ui.jsview("PlantOfflineList", "ui5bp.view.PlantOfflineList"));
        this.app.addDetailPage(sap.ui.jsview("PlantChangedList", "ui5bp.view.PlantChangedList"));
        this.app.addDetailPage(sap.ui.jsview("PlantEdit", "ui5bp.view.PlantEdit"));
        this.app.addDetailPage(sap.ui.jsview("PlantEditOnline", "ui5bp.view.PlantEditOnline"));
        this.app.addDetailPage(sap.ui.jsview("PlantFlush", "ui5bp.view.PlantFlush"));
        this.app.addDetailPage(sap.ui.jsview("PlantRefresh", "ui5bp.view.PlantRefresh"));
