jQuery.sap.require("root.util.Formatter");
jQuery.sap.require("root.util.Controller");

root.util.Controller.extend("root.view.Detail", {
	...
	onRouteMatched : function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function () {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(root.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView : function () {
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "root.view.NotFound",
			targetViewType : "XML"
		});
	},
