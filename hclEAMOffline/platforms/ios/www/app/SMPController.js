jQuery.sap.declare("com.hcl.eamoffline.app.SMPController");
...
com.hcl.eamoffline.app.SMPController = {
    
ggatest: function() {
    
    //console.log("in ggatest " + com.hcl.eamoffline.app.SMPController.appId);
    
},
    

appId: "com.hcl.eamoffline",
...
context: {
    ...
    "https": false,
    "serverPort": "8080",
    "user": "IMohammed6", //user name for registration and OData Endpoint
    "password": "itt123",  //password for registration and OData Endpoint
...
init: function() {
    ...
    var self = com.hcl.eamoffline.app.SMPController;
    ...
    //document.addEventListener("online", com.hcl.eamoffline.app.SMPControllerdeviceOnline, false);
    //document.addEventListener("offline", com.hcl.eamoffline.app.SMPControllerdeviceOffline, false);
    self.register();
...
logonSuccessCallback: function(result) {
    ...
    //this = com.hcl.eamoffline.app.SMPController;
    var self = com.hcl.eamoffline.app.SMPController;
    ...
    //self.read(false);
     sap.ui.jsview("RootView", "root.view.App").placeAt('content');
...
getEndPointURL: function() {
    ...
    return com.hcl.eamoffline.app.SMPController.smpURL + "/com.hcl.eamoffline/";
...
read: function(isLocal, isOnline) {
  ...
  /*  if(isOnline){
   ...
   // var sURL = self.getEndPointURL() + "PlantSet";
     var sURL = self.getEndPointURL() + "WOLIST";
   ...
   // var m = new sap.ui.model.odata.ODataModel("http://us1455saps033.dir.slb.com:8080/com.hcl.eamoffline/", true, "IMohammed6", "itt123");
    
    
    //var m = new sap.ui.model.odata.ODataModel("http://usphlvm1497.phl.sap.corp:8080/com.hcl.eamoffline/", true, "test", "gga", oHeaders, true);
    //m.setSizeLimit(1000);
    //self.plantModel = m;
...
readSuccessCallback: function(data, response) { //not used
    ...
    /*var updatePlantURL = this.getEndPointURL() + "PlantSet(Werks='ZTST',Stand='NEW')";
     ...
     //var m = new sap.ui.model.odata.ODataModel("http://usphlvm1497.phl.sap.corp:8080/com.hcl.eamoffline", true, "I812441", "gga");
...
openStore: function() {
    ...
    var properties = {
        ...
        "serviceRoot" : self.getEndPointURL(), //"com.hcl.eamoffline",
