            ...
            var startRegistration = function(onSuccess, onError, context){
                ...
                if ((cordova.require("cordova/platform").id.indexOf("windows") === 0) && getSAMLConfig(_providedContext) != null) {
                    ...
                    if (getSAMLConfig(_providedContext) == null || SAMLState == "completed") {
                        ...
                        showScreen("SCR_SAML_AUTH")(getSAMLConfig(_providedContext));
                    }
                }
            }
        ...
        //before full registration callback is called.
            this.postMatchAction = function(matchedRule){
               if (matchedRule.action == onFullRegistered ){
                   ...
                   else if (bUnlockPerformed) {  //no need to do saml authentication again if data vault is already unlocked when unlock method is called
...
// === flow launcher methods =====================================
        ...
        var registerOrUnlock = function(onsuccess, onerror) {
            ...
            var flowRunner = new FlowRunner(callbacks, _oLogonView, _oLogonCore, flow);
