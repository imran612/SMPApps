cordova.define("com.sap.mp.cordova.plugins.authproxy.modifyFormSubmit", function(require, exports, module) { if (window.RequestInfoSetter && window.RequestInfoSetter.setAuthProxyRequestInfo && !window.getNextAuthProxyRequestInfoID ) {
