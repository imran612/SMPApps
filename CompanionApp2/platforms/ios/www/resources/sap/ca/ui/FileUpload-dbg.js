 ...
 *
 * @name sap.ca.ui.FileUpload.prototype.abandonPendingRename
 * @function
 ...
 *
 * @name sap.ca.ui.FileUpload.prototype.commitPendingRename
 * @function
 ...
 *
 * @name sap.ca.ui.FileUpload.prototype.isUploading
 * @function
 ...
 *
 * @name sap.ca.ui.FileUpload.prototype.abortUpload
 * @function
...
sap.ca.ui.FileUpload.prototype.init = function () {
    ...
    var _oCancelIcon = new sap.m.Button({
        ...
        press: jQuery.proxy(function (oEv) {
            ...
            var fnAbortXhr = oControl.getModel().getProperty(sPath + "/abortUplXhr");
    ...
    var _oEditIcon = new sap.m.Button({
        ...
        visible: { parts: [
            ...
            formatter: jQuery.proxy(function (isRenameEnabled, isUploading) {
                return isRenameEnabled && (!isUploading);
            }, this)
...
sap.ca.ui.FileUpload.prototype._handleDelete = function (event) {
    var fileToDelete = event.getParameter("listItem").getBindingContext().getProperty();
...
sap.ca.ui.FileUpload.prototype._handleEdit = function (e) {
    // We are setting the _editBtnPressedPath to null because now the button is released we don't need to care about it
    this._editBtnPressedPath = null;
...
sap.ca.ui.FileUpload.prototype._focusEdit = function (oLineItem, oInput) {
    if (!jQuery.os.iOS) {
        ...
        $input.one("focusout blur", jQuery.proxy(function () {
            // We check if we have pressed an edit btn and if so, is it the same one ?
            if( this._editBtnPressedPath == null || this._editBtnPressedPath != oLineItem.getBindingContext().getPath()){
