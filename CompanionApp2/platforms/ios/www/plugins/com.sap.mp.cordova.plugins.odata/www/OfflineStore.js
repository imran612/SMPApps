cordova.define("com.sap.mp.cordova.plugins.odata.OfflineStore", function(require, exports, module) { // 3.5.5
 ...
 * @callback OfflineStore~requesterror
 * @param {String} error - The error message.
 */

/**
 * Offline store success callback.
 * @callback OfflineStore~success
 */

/**
 * Offline store error callback.
 * @callback OfflineStore~error
 * @param {String} error - The error message.
 */
 ...
 * @param {OfflineStore~success} success - Called when store successfully opens.
 * @param {OfflineStore~error} error - Called when store fails to open.
 ...
 * @param {OfflineStore~success} success - Called when store successfully closes.
 * @param {OfflineStore~error} error - Called when store fails to close.
 */
 ...
 * @param {OfflineStore~success} success - Called when store is successfully refreshed.
 * @param {OfflineStore~error} error - Called if store fails to refresh itself.
 ...
 * @param {OfflineStore~success} success - Called when store is successfully cleared.
 * @param {OfflineStore~error} error - Called if store cannot be cleared.
 */
 ...
 * The application must have network connectivity to perform this operation.
 * @param {OfflineStore~success} success - Called when flush has finished.
 * @param {OfflineStore~error} error - Called if error calling flush.
 */
