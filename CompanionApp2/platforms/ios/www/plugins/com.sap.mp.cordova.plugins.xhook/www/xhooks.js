cordova.define("com.sap.mp.cordova.plugins.xhook.Xhook", function(require, exports, module) { // XHook - v1.1.9 - https://github.com/jpillora/xhook
        ...
        facade.send = function (body) {
            ...
            process = function () {
                ...
                if (hook.length === 1) {
                    ...
                    // Kapsel modification: only allow an async hook if the xhr is async.
                    // Otherwise throw an exception.
                    if (request.async) {
                        return hook(request, done);
                    } else {
                        throw "Asynchronous hook not supported for synchronous request.";
                    }
                }
            };
            process();
