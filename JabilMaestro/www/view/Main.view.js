...
function loadOrderStatusContent(page,controller){
    ...
    var srchLyt = new sap.m.FlexBox();
    srchLyt.addItem(new sap.m.Switch("poPNSwitch",{state:true,customTextOn:"PO",customTextOff:"PN"}).addStyleClass("poPNSwitchStyle"));
    srchLyt.addItem(new sap.m.SearchField("orderSearch", {search: controller.searchOrder}).addStyleClass("orderSearchStyle"));
    //Create search field and add to page
    osLyt.addItem(srchLyt);
