 ...
 */
jQuery.sap.declare("sap.ca.ui.ZoomableScrollContainer");jQuery.sap.require("sap.ca.ui.library");jQuery.sap.require("sap.m.ScrollContainer");sap.m.ScrollContainer.extend("sap.ca.ui.ZoomableScrollContainer",{metadata:{deprecated:true,library:"sap.ca.ui",properties:{"zoomable":{type:"boolean",group:"Misc",defaultValue:true},"initialScale":{type:"float",group:"Misc",defaultValue:1},"minScale":{type:"float",group:"Misc",defaultValue:1},"maxScale":{type:"float",group:"Misc",defaultValue:4}}}});
/*
