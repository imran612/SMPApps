...
sap.ui.define(["jquery.sap.global", "sap/ui/fl/Change"], function($, Change) {
	"use strict";

	/**
	 * @constructor
	 * @class DefaultVariant handles default variant changes without keeping control specific state.
	 *        It knows how to create a default variant change, how to retrieve the default variant id from a given list of changes, etc.
	 * @name sap.ui.fl.DefaultVariant
	 * @author SAP SE
	 *
	 * @version ${version}
	 *
	 ...
	 *
	 * @public
	 * @name sap.ui.fl.DefaultVariant#getDefaultVariantId
	 * @function
	 */
	 ...
	 *
	 * @public
	 * @name sap.ui.fl.DefaultVariant#getNewestDefaultVariantChangeDeleteTheRest
	 * @function
	 */
	 ...
	 *
	 * @public
	 * @name sap.ui.fl.DefaultVariant#getDefaultVariantChanges
	 * @function
	 */
	 ...
	 *
	 * @name sap.ui.fl.DefaultVariant#updateDefaultVariantId
	 * @public
	 * @function
	 */
	 ...
	 *
	 * @private
	 * @name sap.ui.fl.DefaultVariant#_createChangeFile
	 * @function
	 */
	 ...
	 * @param {String} mParameters.component - name of the UI5 component
	 * @param {object} mParameters.selector - stable propertyName:propertyValue
	 * @param {function} fnDeleteCallback - this callback will be called, when the change is
	 *                         deleted and has to be handled by the sap.ui.fl.Persistence
	 *
	 * @returns {sap.ui.fl.Change} Change
	 *
	 * @public
	 * @name sap.ui.fl.DefaultVariant#createChangeObject
	 * @function
	 */
	DefaultVariant.prototype.createChangeObject = function(mParameters, fnDeleteCallback) {
		var oFileContent, oChange;

		oFileContent = this._createChangeFile(mParameters);
		oChange = new Change(oFileContent, fnDeleteCallback);
