...
*/
	onInit: function() {
		...
		this.getView().byId(this._FORWARD_DIALOG_ID).setInitialFocus(fldSearch);
	},
	...
	onBeforeOpenDialog: function() {
		...
		//0120031469 0004003014 2013 //remove the remaining selection
		this.getView().byId(this._FORWARDER_LIST_ID).removeSelections(true);
	},
