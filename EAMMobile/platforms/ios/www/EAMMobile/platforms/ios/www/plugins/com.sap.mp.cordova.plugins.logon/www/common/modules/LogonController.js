cordova.define("com.sap.mp.cordova.plugins.logon.Logon", function(require, exports, module) {     var utils = sap.logon.Utils;
    ...
    var startLogonInit = function(context){
        ...
        if ( device.platform.toLowerCase() == "ios" ){
            ...
            } else if (context.appConfig.certificate && device.platform.toLowerCase().indexOf("android") >= 0) {
                // For SP07, non-SMP cert provider is just done on Android.
                sap.logon.Core.provisionCertificate(logon, appDelegate.onRegistrationError, context.appConfig.certificate);
            }
            else{
                logon();
            }
