 ...
 * @public
 * @name sap.me.Calendar#getSelectionMode
 * @function
 */
 ...
 * @return {sap.me.Calendar} <code>this</code> to allow method chaining
 * @public
 * @name sap.me.Calendar#setSelectionMode
 * @function
 */
 ...
 *
 * @name sap.me.Calendar#getSelectedDates
 * @function
 * @type any
 * @public
 ...
 *
 * @name sap.me.Calendar#toggleDatesSelection
 * @function
 * @param {any} oADates
 ...
 *
 * @name sap.me.Calendar#toggleDatesRangeSelection
 * @function
 ...
 *
 * @name sap.me.Calendar#unselectAllDates
 * @function
 * @type void
 * @public
 * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
 ...
 *
 * @name sap.me.Calendar#toggleDatesType
 * @function
 * @param {any} oADates
...
sap.me.Calendar.prototype.init = function () {
    ...
    this.__setCurrentDate((new sap.me.CalendarDate().toDateString()), true);
    ...
    this._oLocaleData = sap.ui.core.LocaleData.getInstance(this._oLocale);
};
...
sap.me.Calendar.prototype.getEnableMultiselection = function () {
...
sap.me.Calendar.prototype.setDisabledDates = function (aDates) {
    ...
    for (i = 0; i < aDates.length; i++) {
        ...
        if (typeof oDate == "string") {
            ...
            oDate = sap.me.CalendarDate.parseFromToDateString(oDate);
        }
...
sap.me.Calendar.prototype.toggleDatesRangeSelection = function (oDateStart, oDateEnd, bSelected) {
...
sap.me.Calendar.prototype._toggleDatesRangeStyleClass = function (sClass, oDateStart, oDateEnd, bActive) {
    if (typeof oDateStart == "string") {
        // this will change the type of oDateStart from String to Date.
        oDateStart = sap.me.CalendarDate.parseFromToDateString(oDateStart);
    }
    if (typeof oDateEnd == "string") {
        // this will change the type of oDateEnd from String to Date.
        oDateEnd = sap.me.CalendarDate.parseFromToDateString(oDateEnd);
    }
...
sap.me.Calendar.prototype._toggleDatesStyleClass = function (sClass, aDates, bActive) {
    var i;
    for (i = 0; i < aDates.length; i++) {
        var oDate = aDates[i];
        if (typeof oDate == "string") {
...
sap.me.Calendar.prototype._updateDatesWithClass = function (sClass, sDate, bActive) {
...
sap.me.Calendar.prototype._checkLanguageRegion = function (language, region) {
    return (region === this._oLocale.getRegion() && language === this._oLocale.getLanguage());
};

sap.me.Calendar.prototype._getIntervalPattern = function (pattern) {
    return this._oLocaleData.getIntervalPattern(pattern);
};

sap.me.Calendar.prototype.getCurrentDate = function () {
 ...
 * @public
 */
sap.me.Calendar.prototype.setCurrentDate = function (strDate) {
 ...
 * @private
 */
sap.me.Calendar.prototype.__setCurrentDate = function (strDate, bSuppressInvalidate) {
    this._oInternalDate = new sap.me.CalendarDate(sap.me.CalendarDate.parseFromToDateString(strDate));
 ...
 */
sap.me.Calendar.parseDate = function (strDate) {
    // DO NOT USE sap.me.CalendarDate directly
    return sap.me.CalendarDate.parseFromToDateString(strDate, true);
};