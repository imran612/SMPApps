jQuery.sap.declare("com.hcl.app.SMPController");

//jQuery.sap.require("sap.ui.model.resource.ResourceModel");

com.hcl.app.SMPController = {
    
ggatest: function() {
    
    //console.log("in ggatest " + com.hcl.app.SMPController.appId);
    
},
    
    
    
appId: "com.hcl.offline",
...
init: function() {
    ...
    var self = com.hcl.app.SMPController;
    ...
    //document.addEventListener("online", com.hcl.app.SMPControllerdeviceOnline, false);
    //document.addEventListener("offline", com.hcl.app.SMPControllerdeviceOffline, false);
    self.register();
...
logonSuccessCallback: function(result) {
    ...
    //this = com.hcl.app.SMPController;
    var self = com.hcl.app.SMPController;
...
getEndPointURL: function() {
    ...
    return com.hcl.app.SMPController.smpURL + "/com.hcl/";
...
read: function(isLocal, isOnline) {
   ...
   // clientCert = new sap.AuthProxy.CertificateFromLogonManager("com.mycompany.logon");
    ...
    var m = new sap.ui.model.odata.ODataModel("http://us1455saps033.dir.slb.com:8080/com.hcl.offline/", true, "IMohammed6", "itt123");
    
    
    //var m = new sap.ui.model.odata.ODataModel("http://usphlvm1497.phl.sap.corp:8080/com.hcl/", true, "test", "gga", oHeaders, true);
    //m.setSizeLimit(1000);
    //self.plantModel = m;
...
readSuccessCallback: function(data, response) { //not used
    ...
    /*var updatePlantURL = this.getEndPointURL() + "PlantSet(Werks='ZTST',Stand='NEW')";
     ...
     //var m = new sap.ui.model.odata.ODataModel("http://usphlvm1497.phl.sap.corp:8080/com.hcl", true, "I812441", "gga");
...
openStore: function() {
    ...
    var properties = {
        ...
        "serviceRoot" : self.getEndPointURL(), //"com.hcl",
