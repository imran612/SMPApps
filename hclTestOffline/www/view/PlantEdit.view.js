...
sap.ui.jsview("ui5bp.view.PlantEdit", {

    getControllerName: function() {
        return "ui5bp.view.PlantEdit";
    },
    ...
    createContent: function(oController) {
        ...
        var oBtnSave = new sap.m.Button({
            ...
            press : function(ev) {
              ...
              var oLabel = new sap.ui.commons.Label("lbWerks", {
                                                    text: 'Werks',
                                                    labelFor: oTF
                                                    });
              ...
              oLabel = new sap.ui.commons.Label("lbStand", {
                                                text: 'Stand',
                                                labelFor: oTF
                                                });
              ...
              // Label for the e-mail field
              oLabel = new sap.ui.commons.Label("lbKtext", {
                                                text: 'Ktext',
                                                labelFor: oTF
                                                });
