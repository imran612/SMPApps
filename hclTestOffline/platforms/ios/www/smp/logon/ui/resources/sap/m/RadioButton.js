...
sap.m.RadioButton.prototype.ontap=function(){if(!this.getEnabled()){return}this.applyFocusInfo();if(this.getSelected()){return}this.setSelected(true);var t=this;setTimeout(function(){t.fireSelect({selected:true})},0)};
...
sap.m.RadioButton.prototype.setTabIndex=function(t){this._iTabIndex=t;this.$("Button").attr("tabindex",t);return this};
